...
const CreateTrapCard = () => {

    const navigation = useNavigate();
    const location = useLocation();

    const [card, setCard] = React.useState<card.Trap>({
        subType: 'Normal',
        effect: [],
        archetypes: []
    })
    ...
    function createCard() {
        ...
        fetch('http://localhost:8000/admin/cards/traps/create', {
            method: 'POST',
            headers: {
